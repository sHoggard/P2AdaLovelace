...
double error = 0;              // felvärde
 ...
 int t = 10;               // samplingstid
 double uV = 0;              // hastighet för vänsterhjul
 double uH = 0;              // hastighet för högerhjul
 double pi = 3.14159265359;
 double omkretsV = 486; // millimeter
 double omkretsH = 488.5; // millimeter
...
//  
    ...
    uV = ((historyLeft[0] - historyLeft[windowSize])*omkretsV)/(N*t);
    uH = ((historyRight[0] - historyRight[windowSize])*omkretsH)/(N*t);
...
if (millis()%1000 < t) {
  ...
  printString.concat("\nLeft counter: ");
  printString.concat(counterLeft*omkretsV/144);
  printString.concat("\nRight counter: ");
  printString.concat(counterRight*omkretsH/144);
  printString.concat("\nDifference: ");
  printString.concat((counterLeft*omkretsV - counterRight*omkretsH)/144);
  printString.concat("\n");
